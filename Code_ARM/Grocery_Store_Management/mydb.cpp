...
void MyDB::init()
{
    ...
    db.setDatabaseName("c:/Users/hbyfn/Desktop/Grocery_Store_Management/manager_database.sqlite");

    if(QFile::exists("c:/Users/hbyfn/Desktop/Grocery_Store_Management/manager_database.sqlite"))
